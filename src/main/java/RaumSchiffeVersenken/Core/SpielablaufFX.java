...
public class SpielablaufFX {
    ...
    public void SchiffeSetzenAblauf() {
        ...
        log.info("Bomber 1" + SchiffsMap.put(5, Objects.requireNonNull(SchiffFactory.getRaumschiff("2"))));
        log.info("Bomber 2" + SchiffsMap.put(6, Objects.requireNonNull(SchiffFactory.getRaumschiff("2"))));
        log.info("Bomber 3" + SchiffsMap.put(7, Objects.requireNonNull(SchiffFactory.getRaumschiff("2"))));
        SchiffsMap.put(5, Objects.requireNonNull(SchiffFactory.getRaumschiff("2")));
        ...
        log.info("Fregatte 1" + SchiffsMap.put(8, Objects.requireNonNull(SchiffFactory.getRaumschiff("4"))));
        log.info("Fregatte 2" + SchiffsMap.put(9, Objects.requireNonNull(SchiffFactory.getRaumschiff("4"))));
        SchiffsMap.put(8, Objects.requireNonNull(SchiffFactory.getRaumschiff("4")));
